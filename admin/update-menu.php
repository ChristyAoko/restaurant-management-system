...
<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        //Get the individual values of selected foods
        $title = $row2['title'];
    ...
    <div class="wrapper">
        ...
        if(isset($_POST['submit']))
        {
			...
			if(isset($_FILES['image']['name']))
			{
				...
				{
					$image_name = $current_image; //Default image when not selected
				}
			}
			else 
			{
				$image_name = $current_image; //Default image button is not clicked
			}
